...
export default function AdminElevenPage() {
  ...
  const table6Columns = React.useMemo(() => {
    ...
    return [
      table6ColumnHelper.accessor("tablecell", {
        cell: (info) => (
      ...
      table6ColumnHelper.accessor("areasone", {
        cell: (info) => (
      ...
      table6ColumnHelper.accessor("review", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table6ColumnHelper.accessor("views", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table6ColumnHelper.accessor("rowview", {
        cell: (info) => (
          <div className="flex">
    ...
    <>
      ...
      <div className="w-full bg-gray-50_01">
        ...
        <div className="flex md:flex-col justify-center">
          ...
          <div className="md:self-stretch p-[39px] md:p-5 flex-1">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-[23px]">
                <div className="flex md:flex-col justify-between items-start gap-5">
                  ...
                  <div className="flex sm:flex-col justify-center items-center w-[44%] md:w-full gap-2">
