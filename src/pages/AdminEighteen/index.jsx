...
export default function AdminEighteenPage() {
  return (
    <>
      <Helmet>
      ...
      <div className="flex flex-col items-start w-full bg-gray-50_01">
        <div className="self-stretch">
          <Header2 className="p-4 bg-gray-100_02" />
        </div>
        <div className="flex md:flex-col justify-between items-start w-[68%] md:w-full gap-5 md:p-5">
          <Sidebar1 className="flex flex-col h-screen w-[202px] top-0 py-10 sm:py-5 bg-gray-100_02 !sticky overflow-auto md:hidden" />
          <div className="flex flex-col md:self-stretch gap-5 flex-1">
            <div className="flex sm:flex-col justify-between items-center gap-5">
              ...
              <Button size="3xl" shape="round" className="self-end mb-0.5 sm:px-5 uppercase font-medium min-w-[210px]">
                Leave a review
              </Button>
            </div>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col pb-[17px] gap-4 flex-1">
                ...
                <div className="flex justify-center border-blue_gray-100 border-b border-solid">
                  <div className="flex gap-8">
                    ...
                    <div className="flex self-end items-start pr-px py-px">
        ...
        <div className="flex md:flex-row sm:flex-col w-[61%] md:w-full mt-4 ml-60 gap-8 md:p-5 md:ml-0">
          <div className="flex items-center mb-1 py-px sm:mb-0">
          ...
          <div className="flex items-start pr-px py-px">
            <Img src="images/img_settings.svg" alt="settings_one" className="h-[24px] w-[24px]" />
        ...
        <div className="h-px w-[61%] mt-4 ml-60 md:ml-0 bg-blue_gray-100" />
      </div>
    </>
  );
}
