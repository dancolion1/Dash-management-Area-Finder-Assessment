...
export default function AdminSeventeenPage() {
  ...
  const table10Columns = React.useMemo(() => {
    ...
    return [
      table10ColumnHelper.accessor("tablecell", {
        cell: (info) => (
      ...
      table10ColumnHelper.accessor("areasone", {
        cell: (info) => (
      ...
      table10ColumnHelper.accessor("name", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table10ColumnHelper.accessor("review", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table10ColumnHelper.accessor("views", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table10ColumnHelper.accessor("status", {
        cell: (info) => (
      ...
      table10ColumnHelper.accessor("rowview", {
        cell: (info) => (
          <div className="flex">
              ...
              <div className="flex md:flex-col justify-between items-center gap-5">
                ...
                <div className="flex md:flex-col justify-center items-end w-[73%] md:w-full">
                  ...
                  <Button
                    size="xl"
                    shape="round"
                    className="ml-[3px] md:ml-0 sm:px-5 uppercase font-medium min-w-[159px] !rounded"
                  >
                    create REVIEW
                  </Button>
                  <Input
