...
export default function AdminFourteenPage() {
  const [searchBarValue53, setSearchBarValue53] = React.useState("");
  const table8Columns = React.useMemo(() => {
    const table8ColumnHelper = createColumnHelper();
    return [
      table8ColumnHelper.accessor("tablecell", {
        cell: (info) => (
      ...
      table8ColumnHelper.accessor("areasone", {
        cell: (info) => (
      ...
      table8ColumnHelper.accessor("review", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table8ColumnHelper.accessor("views", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table8ColumnHelper.accessor("status", {
        cell: (info) => (
      ...
      table8ColumnHelper.accessor("rowview", {
        cell: (info) => (
          <div className="flex">
    ...
    <>
      ...
      <div className="w-full bg-gray-50_01">
        ...
        <div className="flex md:flex-col justify-center">
          ...
          <div className="flex flex-col items-center md:self-stretch gap-[23px] p-[15px] md:p-5 flex-1">
            <div className="flex md:flex-col justify-between items-center w-[96%] md:w-full gap-5">
              <Text size="6xl" as="p" className="self-end mb-[5px]">
                All Reviews Created
              </Text>
              <div className="flex md:flex-col justify-center items-start w-[73%] md:w-full gap-1">
                <Button
                  color="deep_orange_50"
                  size="5xl"
                  shape="round"
                  leftIcon={<Img src="images/img_checkcircle_red_600.svg" alt="check-circle" />}
                  className="mb-2.5 gap-3 sm:px-5 font-clashdisplay font-medium border-red-600 border border-solid min-w-[339px]"
                >
                  Review Created Not Successful
                </Button>
                <div className="flex sm:flex-col justify-center items-center md:self-stretch gap-2 flex-1">
                  <Button size="xl" shape="round" className="sm:px-5 uppercase font-medium min-w-[159px] !rounded">
                    create REVIEW
                  </Button>
                  <Input
                    size="xs"
                    ...
                    name="search"
                    placeholder={`Search`}
                    value={searchBarValue53}
                    onChange={(e) => setSearchBarValue53(e)}
                    prefix={<Img src="images/img_rewind.svg" alt="rewind" className="cursor-pointer" />}
                    suffix={
                      searchBarValue53?.length > 0 ? (
                        <CloseSVG
                          onClick={() => setSearchBarValue53("")}
                          height={10}
                          width={10}
                          fillColor="#8f95b2ff"
                        />
            ...
            <ReactTable
              ...
              data={table8Data}
            />
            <div className="flex md:flex-col justify-between items-center w-[96%] md:w-full mb-[25px] gap-5 border-blue_gray-50 border border-solid">
              <div className="flex">
                <Button
                  color="white_A700"
                  size="xl"
