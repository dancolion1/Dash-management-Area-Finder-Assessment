...
export default function AdminTwentyFivePage() {
  const [searchBarValue63, setSearchBarValue63] = React.useState("");
  const table14Columns = React.useMemo(() => {
    const table14ColumnHelper = createColumnHelper();
    return [
      table14ColumnHelper.accessor("tablecell", {
        cell: (info) => (
      ...
      table14ColumnHelper.accessor("tablecellone", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-l border-b border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table14ColumnHelper.accessor("tablecelltwo", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-l border-b border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table14ColumnHelper.accessor("tablecellthree", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-l border-b border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table14ColumnHelper.accessor("rowtablecell", {
        cell: (info) => (
          <div className="flex">
