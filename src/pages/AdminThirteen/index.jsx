...
export default function AdminThirteenPage() {
  ...
  const table7Columns = React.useMemo(() => {
    ...
    return [
      table7ColumnHelper.accessor("tablecell", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("areasone", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("name", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table7ColumnHelper.accessor("review", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table7ColumnHelper.accessor("views", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table7ColumnHelper.accessor("status", {
        cell: (info) => (
          <div className="flex justify-center">
            <div className="flex justify-center items-center w-full mt-[3px]">
              <div className="flex self-end mb-[22px] p-3.5 border-blue_gray-50 border-b border-r border-solid flex-1">
                <Text as="p" className="self-start !text-red-600 !font-medium">
                  {info?.getValue?.()}
                </Text>
              </div>
              <div className="flex flex-col items-center w-[35%] ml-[-67px] pb-[7px] relative border-gray-600 border border-solid bg-gray-50_01">
                <div className="flex p-1.5 border-gray-600 border-b border-solid bg-gray-50_03">
                  <Text as="p" className="self-end text-center">
                    Approve
                  </Text>
                </div>
                <Button color="gray_600" size="xl" variant="outline" shape="square" className="w-full">
                  Decline
                </Button>
                <Text as="p" className="mt-[7px] text-center">
                  View
                </Text>
              </div>
            </div>
      ...
      table7ColumnHelper.accessor("rowview", {
        cell: (info) => (
          <div className="flex">
            <div className="flex flex-col items-center justify-center mt-3.5 p-1 border-blue_gray-50 border-b border-r border-solid">
