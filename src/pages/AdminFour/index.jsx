...
export default function AdminFourPage() {
  ...
  const table2Columns = React.useMemo(() => {
    ...
    return [
      ...
      table2ColumnHelper.accessor("areasone", {
        cell: (info) => (
          <Text as="p" className="md:p-5 border-blue_gray-50 border-l border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table2ColumnHelper.accessor("views", {
        cell: (info) => (
          <Text as="p" className="md:p-5 border-blue_gray-50 border-l border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table2ColumnHelper.accessor("reviewsone", {
        cell: (info) => (
          <Text as="p" className="md:p-5 border-blue_gray-50 border-l border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table2ColumnHelper.accessor("view", {
        cell: (info) => (
        ...
        <div className="flex flex-col items-start w-full">
          <div className="flex flex-col self-stretch items-end">
            ...
            <Button
              ...
              className="mt-[-25px] mr-[450px] gap-3 md:mr-0 sm:px-5 font-clashdisplay font-medium relative border-green-800 border border-solid min-w-[339px]"
            >
              ...
              <Input
                ...
                suffix={
                  searchBarValue43?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue43("")} height={10} width={10} fillColor="#8f95b2ff" />
                  ) : null
                }
