...
export default function AdminNinePage() {
  ...
  const table4Columns = React.useMemo(() => {
    ...
    return [
      table4ColumnHelper.accessor("tablecell", {
        cell: (info) => (
      ...
      table4ColumnHelper.accessor("areasone", {
        cell: (info) => (
          <Text as="p" className="md:p-5 border-blue_gray-50 border-l border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table4ColumnHelper.accessor("views", {
        cell: (info) => (
          <Text as="p" className="md:p-5 border-blue_gray-50 border-l border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table4ColumnHelper.accessor("reviewsone", {
        cell: (info) => (
          <Text as="p" className="md:p-5 border-blue_gray-50 border-l border-b border-r border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table4ColumnHelper.accessor("view", {
        cell: (info) => (
        ...
        <div className="flex flex-col items-start w-full">
          <div className="flex flex-col self-stretch items-end">
            ...
            <Button
              ...
              className="mt-[-20px] mr-[450px] gap-3 md:mr-0 sm:px-5 font-clashdisplay font-medium relative border-green-800 border border-solid min-w-[339px]"
            >
              Area Edited Successfully
            </Button>
          </div>
          <Sidebar1 className="flex flex-col self-center h-screen w-[202px] mt-[-30px] top-0 py-10 sm:py-5 !sticky bg-gray-100_02 overflow-auto md:hidden" />
        </div>
          ...
          <div className="flex md:flex-col justify-between items-start gap-5">
            ...
            <div className="flex sm:flex-col justify-center items-center w-[42%] md:w-full gap-2 md:p-5">
              ...
              <Input
                ...
                onChange={(e) => setSearchBarValue48(e)}
                prefix={<Img src="images/img_rewind.svg" alt="rewind" className="cursor-pointer" />}
                suffix={
                  searchBarValue48?.length > 0 ? (
                    <CloseSVG onClick={() => setSearchBarValue48("")} height={10} width={10} fillColor="#8f95b2ff" />
                  ) : null
                }
