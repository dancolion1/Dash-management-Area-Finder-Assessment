...
export default function AdminTwentyFourPage() {
  const [searchBarValue62, setSearchBarValue62] = React.useState("");
  const table13Columns = React.useMemo(() => {
    const table13ColumnHelper = createColumnHelper();
    return [
      table13ColumnHelper.accessor("tablecell", {
        cell: (info) => (
      ...
      table13ColumnHelper.accessor("tablecellone", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-l border-b border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table13ColumnHelper.accessor("tablecelltwo", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-l border-b border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table13ColumnHelper.accessor("tablecellthree", {
        cell: (info) => (
          <Text as="p" className="border-blue_gray-50 border-l border-b border-solid">
            {info?.getValue?.()}
          </Text>
      ...
      table13ColumnHelper.accessor("rowtablecell", {
        cell: (info) => (
          <div className="flex">
