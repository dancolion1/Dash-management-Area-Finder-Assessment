...
export default function HomepageSevenPage() {
  return (
    <>
      <Helmet>
      ...
      <div className="w-full pt-6 sm:pt-5 bg-gray-900_05">
        ...
        <div className="flex justify-center px-14 py-[116px] md:p-5">
          <HomepageSevenSignup className="w-[38%] md:w-full bg-black-900 rounded-lg" />
        </div>
      </div>
    </>
  );
