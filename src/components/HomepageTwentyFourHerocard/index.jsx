...
export default function HomepageTwentyFourHerocard({
  circleimage,
  jamest,
  duration,
  ikatelekki,
  ...
  return (
    <div {...props}>
      <div className="flex flex-col w-full gap-2">
        <div className="flex justify-between items-center w-[90%] md:w-full gap-5">
          <div className="flex self-start justify-center w-[43%] gap-1">
            ...
            <div className="flex flex-col">
              {!!jamest ? (
                <Text size="xl" as="p" className="!text-gray-50 !font-medium">
                  {jamest}
                </Text>
              ) : null}
              {!!duration ? (
                <Text size="xs" as="p" className="!text-gray-50">
                  {duration}
                </Text>
              ) : null}
            </div>
        ...
        <Text size="2xl" as="p" className="!text-gray-50 leading-[140%]">
          {description}
        </Text>
        <div className="flex items-center">
          <div className="flex self-start items-center gap-1">
            <Img src="images/img_offer.svg" alt="offer_one" className="h-[14px]" />
          ...
          <div className="flex self-end items-center ml-2 gap-1">
            <Img src="images/img_user.svg" alt="user_one" className="h-[16px] w-[16px]" />
